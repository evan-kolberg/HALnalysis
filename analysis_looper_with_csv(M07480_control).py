...
def process_div_well(div, path, well_no, root_plots_path, folder_name, chip, analysis_path):
    ...
    try:
        ...
        data_path = path
        plts_path = os.path.join(root_plots_path, folder_name, f"DIV{div}", f'WELL{well_no}')
        chip_div_well = f"{chip} | DIV{div} | WELL{well_no}"
        ...
        print(f"Error in {chip_div_well}: {e}")
        traceback.print_exc()


if __name__ == "__main__":

    root_plots_path = "/Users/evankolberg/Desktop/HALnalysis_summer_2024_data/plots"
    folder_name = 'M07480'
    analysis_path = os.path.join(root_plots_path, folder_name)
    chip = "M07480"
    h5_div_paths = {
        28: "/Volumes/Evan/data/M07480/DIV28.h5",
        33: "/Volumes/Evan/data/M07480/DIV33.h5",
        35: "/Volumes/Evan/data/M07480/DIV35.h5",
        41: "/Volumes/Evan/data/M07480/DIV41.h5",
        47: "/Volumes/Evan/data/M07480/DIV47.h5"
    }


    for div, path in h5_div_paths.items():
        for well_no in range(6):
            p = multiprocessing.Process(target=process_div_well, args=(div, path, well_no, root_plots_path, folder_name, chip, analysis_path))
            p.start()
            p.join()
